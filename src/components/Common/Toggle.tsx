    ...
    return (
        <label className="inline-flex items-center cursor-pointer">
            <input 
                ...
                />
            <div className="relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-blue-300 
            ...
            <span className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">Are you Diabetic?</span>
        </label>
    )
}
